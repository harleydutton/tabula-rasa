...
- [Character](#character)
  ...
  - [Skills](#skills-1)
    ...
    - [Gambits](#gambits)
    - [Acquisition](#acquisition-of-skills)
...
> Concept: A character concept can be thought of as the canonical or stereotypical version of something. In this case, is your character a Death Knight? A wizard?

> Story: The story that the Storyteller has provided for the Setting. 
...
### Action Delay
Action Delay determines how frequently you can take an action during a timed event. Default Action Delay is determined by the setting although typical Action Delay is 10. You may spend CP to decrease your Action Delay (increasing the frequency of their Actions) during character creation. However, it costs increasingly more CP for every Action Point you want to Acquire. Conversely, you may choose to make your character larger than normal at an increase to Action Delay.

### Non-Player Characters
Tabula Rasa treats NPCs the same as every other character. NPCs should have Motivations, Skills, Flavor, Action Delay, and all other important properties of a character (but not all are necessary which will be explained later). Creating them should be relatively quick as you only need to fill things in as necessary and can leave most of their character points un-spent. Careful, as this can result in some very min-maxed NPCs. NPCs must have Motivations as it will influence their decisions and interactions with other NPCs and Player Charaters. 

### Printable Character Sheet
![characterSheet.png not found](characterSheet.png "Printable Character Sheet")
## Skills 
Each character has a list of Skills representing the actions they can take in the story. Skills have to be things that a character can *do* which means they have to be able to fail as well. The Setting will have a comprehensive list of Skills available.
<!-- examples -->

### Mandatory Skills
All characters should have the ability to attack, defend, move, hide, see, lie, detect lies, persuade, resist persuasion, etc. The list of mandatory Skills on the Setting should represent these potential actions. All characters must have all mandatory skills for their Setting. Mandatory skills are typically for actions that a character doesn't have a more suitable available skill for actions such as `seeing` or feats of `strength`. 

### Available Skills
Available Skills are those that can be found in a Setting. Not every character has these Skills but most characters should be able to learn them given the opportunity. There will be a list of Available Skills within the Setting document that players can add to their characters. Additionally, players can propose skills be added to the list of available skills found within the Setting (known as Player-Made Skills (PM SKills)).
...
Skills can be obtained during character creation and during the story. In character creation, Skills may be chosen from the Common Skills listed in the Setting or they can be PM Skills. Skills can be acquired by spending CP at this time for a value equal to the desired level. For instance, a level 3 skill would cost 6: 1 point for the first level, 2 CP for the second, and 3 CP for the third level cumulatively. To obtain new skills in the story ask the storyteller if you can being learning the skill.

### Progression
Skills level up once you have succeeded using them a number of times equal to their level. For example, to level up a level 7 `sword-fighting` a player would need to succeed at 7 `sword-fighting` checks. Usually, this will require over 7 attempts because failures do not earn experience towards progression. Mark successes next to the Skill on your character sheet. 
...
### Flavor Acquisition
Flavor can be acquired in three ways. First, it can be created with CP during character creation. It typically costs 1 CP per word for flavor at character creation unless you've made a deal with the Storyteller. Second, it can be earned and paid for during the story similarly to at character creation. The only difference is that the storyteller will make you spend time in character to earn the Flavor you want and may have an additional cost. Thirdly, flavor may be given to or inflicted upon a character as a result of the story. Lands and title may be given to a peasant after he rescues the princess but he may have also taken some fire damage from the dragon guarding here and have a half-melted face now.
