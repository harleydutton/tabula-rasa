...
![Printable Character Sheet is Missing](characterSheet.png "Printable Character Sheet")
...
### War
Once the number of NCPs gets into the double digits it doesn't make a whole lot of sense to actually play the individual characters in combat. In this case the NPCs battle is narrated with the PCs party being able to influence the outcome through their success or failure in smaller combats. This is also a good time to include the event die.
